...
ALTER TABLE [NEUMATICO_POR_AUTO] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [AUTO] ([CODIGO_AUTO])
GO

ALTER TABLE [FRENO_POR_AUTO] ADD FOREIGN KEY ([FRENO_NRO_SERIE]) REFERENCES [FRENO] ([FRENO_NRO_SERIE])
GO

ALTER TABLE [FRENO_POR_AUTO] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [AUTO] ([CODIGO_AUTO])
GO
...
ALTER TABLE [AUTO_POR_INCIDENTE] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [AUTO] ([CODIGO_AUTO])
GO
...
ALTER TABLE [PARADA_BOX] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [AUTO] ([CODIGO_AUTO])
GO
...
ALTER TABLE [TELEMETRIA] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [AUTO] ([CODIGO_AUTO])
GO
