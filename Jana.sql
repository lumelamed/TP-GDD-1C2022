...
--FUNCION EXTRA
-- la consigna que no estaba signada por nadie

create view COSMICOS.cantParadasCircEscAnio as
select COUNT(PB.CODIGO_PARADA_BOX) AS "Cantidad",CI.CIRCUITO_NOMBRE,E.ESCUDERIA_NOMBRE,
...
group by CI.CIRCUITO_NOMBRE,E.ESCUDERIA_NOMBRE,YEAR(CR.CARRERA_FECHA)
--ORDER BY CI.CIRCUITO_NOMBRE,E.ESCUDERIA_NOMBRE, YEAR(CR.CARRERA_FECHA)
GO
