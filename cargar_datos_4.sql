...
SELECT TELE_AUTO_CODIGO, AC.CODIGO_AUTO_POR_CARRERA, M.CODIGO_CARRERA, CODIGO_SECTOR, 
TELE_AUTO_DISTANCIA_CARRERA, TELE_AUTO_DISTANCIA_VUELTA, TELE_AUTO_TIEMPO_VUELTA, TELE_AUTO_POSICION, TELE_AUTO_VELOCIDAD,
...
-- ESTA QUERY COMENTADA NO ANDA, POR UN CONFLICTO DE FKs CON NUESTRA TABLA NEUMATICO. ESTO SE DEBE A UN ERROR DE DATOS EN LA TABLA MAESTRA, 
-- SOBRE LA QUE UN COMPAÑERO MANDO UN MAIL QUE VARIOS OTROS RESPALDARON 
...
-- PARA HACER QUE NO ROMPA, AGREGAMOS LA CONDICION DE QUE EL NEUMATICO TIENE QUE EXISTIR EN NUESTRA TABLA
-- SIN EMBARGO, DE ESTA MANERA NO TIENE LA MISMA CANTIDAD DE REGISTROS QUE LA TABLA DE TELEMETRIA DE LOS FRENOS (TIENE MENOS),
-- POR LA INCONSISTENCIA DE DATOS EN LA TABLA MAESTRA EXPLICADA ANTERIORMENTE
-- EN EL CODIGO DE LA TELEMETRIA, VIENE DEVOLVIENDO BIEN LAS 4 MEDICIONES DE NEUMATICOS POR TELEMETRIA 
-- DESDE LA TELEMETRIA 1 HASTA LA 218.217, LUEGO, SALTA A LA 219.118 (RARO)
INSERT COSMICOS.TELEMETRIA_NEUMATICO (TELE_NEUMATICO_NRO_SERIE, TELE_NEUMATICO_PRESION, TELE_NEUMATICO_PROFUNDIDAD, TELE_NEUMATICO_TEMPERATURA, CODIGO_TELE)
SELECT TELE_NEUMATICO1_NRO_SERIE, TELE_NEUMATICO1_PRESION, TELE_NEUMATICO1_PROFUNDIDAD, TELE_NEUMATICO1_TEMPERATURA, CODIGO_TELE
FROM gd_esquema.Maestra M
JOIN COSMICOS.TELEMETRIA T ON T.TELE_AUTO_DISTANCIA_CARRERA = M.TELE_AUTO_DISTANCIA_CARRERA 
...
JOIN COSMICOS.AUTO_POR_CARRERA AC ON AC.CODIGO_AUTO = AU.CODIGO_AUTO 
	AND M.CODIGO_CARRERA = AC.CODIGO_CARRERA
	AND T.CODIGO_AUTO_POR_CARRERA = AC.CODIGO_AUTO_POR_CARRERA
WHERE EXISTS (SELECT NEUMATICO_NRO_SERIE FROM COSMICOS.NEUMATICO WHERE NEUMATICO_NRO_SERIE = TELE_NEUMATICO1_NRO_SERIE)
UNION
SELECT TELE_NEUMATICO2_NRO_SERIE, TELE_NEUMATICO2_PRESION, TELE_NEUMATICO2_PROFUNDIDAD, TELE_NEUMATICO2_TEMPERATURA, CODIGO_TELE
FROM gd_esquema.Maestra M
JOIN COSMICOS.TELEMETRIA T ON T.TELE_AUTO_DISTANCIA_CARRERA = M.TELE_AUTO_DISTANCIA_CARRERA 
...
JOIN COSMICOS.AUTO_POR_CARRERA AC ON AC.CODIGO_AUTO = AU.CODIGO_AUTO 
	AND M.CODIGO_CARRERA = AC.CODIGO_CARRERA
	AND T.CODIGO_AUTO_POR_CARRERA = AC.CODIGO_AUTO_POR_CARRERA
WHERE EXISTS (SELECT NEUMATICO_NRO_SERIE FROM COSMICOS.NEUMATICO WHERE NEUMATICO_NRO_SERIE = TELE_NEUMATICO2_NRO_SERIE)
UNION
SELECT TELE_NEUMATICO3_NRO_SERIE, TELE_NEUMATICO3_PRESION, TELE_NEUMATICO3_PROFUNDIDAD, TELE_NEUMATICO3_TEMPERATURA, CODIGO_TELE
FROM gd_esquema.Maestra M
JOIN COSMICOS.TELEMETRIA T ON T.TELE_AUTO_DISTANCIA_CARRERA = M.TELE_AUTO_DISTANCIA_CARRERA 
...
JOIN COSMICOS.AUTO_POR_CARRERA AC ON AC.CODIGO_AUTO = AU.CODIGO_AUTO 
	AND M.CODIGO_CARRERA = AC.CODIGO_CARRERA
	AND T.CODIGO_AUTO_POR_CARRERA = AC.CODIGO_AUTO_POR_CARRERA
WHERE EXISTS (SELECT NEUMATICO_NRO_SERIE FROM COSMICOS.NEUMATICO WHERE NEUMATICO_NRO_SERIE = TELE_NEUMATICO3_NRO_SERIE)
UNION
SELECT TELE_NEUMATICO4_NRO_SERIE, TELE_NEUMATICO4_PRESION, TELE_NEUMATICO4_PROFUNDIDAD, TELE_NEUMATICO4_TEMPERATURA, CODIGO_TELE
FROM gd_esquema.Maestra M
JOIN COSMICOS.TELEMETRIA T ON T.TELE_AUTO_DISTANCIA_CARRERA = M.TELE_AUTO_DISTANCIA_CARRERA 
...
JOIN COSMICOS.AUTO_POR_CARRERA AC ON AC.CODIGO_AUTO = AU.CODIGO_AUTO 
	AND M.CODIGO_CARRERA = AC.CODIGO_CARRERA
	AND T.CODIGO_AUTO_POR_CARRERA = AC.CODIGO_AUTO_POR_CARRERA
WHERE EXISTS (SELECT NEUMATICO_NRO_SERIE FROM COSMICOS.NEUMATICO WHERE NEUMATICO_NRO_SERIE = TELE_NEUMATICO4_NRO_SERIE)
ORDER BY 5
