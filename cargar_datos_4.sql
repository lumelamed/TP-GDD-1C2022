...
( CODIGO_TELE,TELE_AUTO_DISTANCIA_VUELTA, TELE_AUTO_DISTANCIA_CARRERA,TELE_AUTO_POSICION,
...
SELECT DISTINCT TELE_NEUMATICO1_NRO_SERIE, TELE_NEUMATICO1_PRESION,TELE_NEUMATICO1_PROFUNDIDAD, TELE_NEUMATICO1_TEMPERATURA, CODIGO_TELE
 FROM gd_esquema.Maestra as M
 ...
 AND T.TELE_AUTO_COMBUSTIBLE = M.TELE_AUTO_COMBUSTIBLE
 UNION
 SELECT DISTINCT TELE_NEUMATICO2_NRO_SERIE, TELE_NEUMATICO2_PRESION,TELE_NEUMATICO2_PROFUNDIDAD, TELE_NEUMATICO2_TEMPERATURA, CODIGO_TELE
 FROM gd_esquema.Maestra as M
 JOIN COSMICOS.Telemetria as T on 
 T.TELE_AUTO_DISTANCIA_CARRERA = M.TELE_AUTO_DISTANCIA_CARRERA 
 AND T.TELE_AUTO_DISTANCIA_VUELTA = M.TELE_AUTO_DISTANCIA_VUELTA
 ...
 AND T.TELE_AUTO_COMBUSTIBLE = M.TELE_AUTO_COMBUSTIBLE
 UNION
 SELECT DISTINCT TELE_NEUMATICO3_NRO_SERIE, TELE_NEUMATICO3_PRESION,TELE_NEUMATICO3_PROFUNDIDAD, TELE_NEUMATICO3_TEMPERATURA, CODIGO_TELE
 FROM gd_esquema.Maestra as M
 JOIN COSMICOS.Telemetria as T on 
 T.TELE_AUTO_DISTANCIA_CARRERA = M.TELE_AUTO_DISTANCIA_CARRERA 
 AND T.TELE_AUTO_DISTANCIA_VUELTA = M.TELE_AUTO_DISTANCIA_VUELTA
 ...
 AND T.TELE_AUTO_COMBUSTIBLE = M.TELE_AUTO_COMBUSTIBLE
 UNION
 SELECT DISTINCT TELE_NEUMATICO4_NRO_SERIE, TELE_NEUMATICO4_PRESION,TELE_NEUMATICO4_PROFUNDIDAD, TELE_NEUMATICO4_TEMPERATURA, CODIGO_TELE
 FROM gd_esquema.Maestra as M
 JOIN COSMICOS.Telemetria as T on 
 T.TELE_AUTO_DISTANCIA_CARRERA = M.TELE_AUTO_DISTANCIA_CARRERA 
 AND T.TELE_AUTO_DISTANCIA_VUELTA = M.TELE_AUTO_DISTANCIA_VUELTA
