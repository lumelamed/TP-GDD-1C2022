...
CREATE TABLE [COSMICOS].[NEUMATICO_POR_AUTO] (
  [CODIGO_NEUMATICO_POR_AUTO] int PRIMARY KEY IDENTITY(1, 1),
...
CREATE TABLE [COSMICOS].[FRENO_POR_AUTO] (
  [CODIGO_FRENO_POR_AUTO] int PRIMARY KEY IDENTITY(1, 1),
...
CREATE TABLE [COSMICOS].[TELEMETRIA] (
  ...
  [CODIGO_AUTO] decimal(18, 0) NOT NULL,
  [CODIGO_CARRERA] int NOT NULL,
  [CODIGO_SECTOR] int NOT NULL,
  [TELE_CODIGO_AUTO_VUELTA] decimal(18, 0),
...
ALTER TABLE [COSMICOS].[AUTO] ADD FOREIGN KEY ([MOTOR]) REFERENCES [COSMICOS].[MOTOR] ([MOTOR_NRO_SERIE])
GO

ALTER TABLE [COSMICOS].[AUTO] ADD FOREIGN KEY ([CAJA_NRO_SERIE]) REFERENCES [COSMICOS].[CAJA] ([CAJA_NRO_SERIE])
GO
...
ALTER TABLE [COSMICOS].[NEUMATICO_POR_AUTO] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [COSMICOS].[AUTO] ([CODIGO_AUTO])
GO

ALTER TABLE [COSMICOS].[FRENO_POR_AUTO] ADD FOREIGN KEY ([FRENO_NRO_SERIE]) REFERENCES [COSMICOS].[FRENO] ([FRENO_NRO_SERIE])
GO

ALTER TABLE [COSMICOS].[FRENO_POR_AUTO] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [COSMICOS].[AUTO] ([CODIGO_AUTO])
GO
...
ALTER TABLE [COSMICOS].[AUTO_POR_INCIDENTE] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [COSMICOS].[AUTO] ([CODIGO_AUTO])
GO
...
ALTER TABLE [COSMICOS].[PARADA_BOX] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [COSMICOS].[AUTO] ([CODIGO_AUTO])
GO
...
ALTER TABLE [COSMICOS].[TELEMETRIA] ADD FOREIGN KEY ([CODIGO_AUTO]) REFERENCES [COSMICOS].[AUTO] ([CODIGO_AUTO])
GO
