...
JOIN COSMICOS.PILOTO AS P on P.PILOTO_NOMBRE = M.PILOTO_NOMBRE and P.PILOTO_APELLIDO = M.PILOTO_APELLIDO
...
ORDER BY E.CODIGO_ESCUDERIA, M.AUTO_NUMERO
...
-- NEUMATICO_POR_AUTO
-- inicialmente, cargamos todos los neumaticos con activo en 0
...
-- Luego, seteamos en 1 los NEUMATICO_NRO_SERIE activos
...
FETCH NEXT FROM CURSOR_NEUMATICOS INTO  @cod_auto_carrera
...
-- FRENO_POR_AUTO
-- como con los neumaticos, inicialmente, cargamos todos los frenos con activo en 0
...
-- Luego, seteamos en 1 los FRENO_POR_AUTO activos 
