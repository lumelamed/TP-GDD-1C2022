...
CREATE TABLE [COSMICOS].[TELEMETRIA] (
  [CODIGO_TELE] int PRIMARY KEY IDENTITY(1, 1), --agregado por nosotros
  [CODIGO_AUTO] int NOT NULL,
  [CODIGO_CARRERA] int NOT NULL,
  [CODIGO_SECTOR] int NOT NULL,
...
ALTER TABLE [COSMICOS].[AUTO] ADD FOREIGN KEY ([MOTOR_NRO_SERIE]) REFERENCES [COSMICOS].[MOTOR] ([MOTOR_NRO_SERIE])
GO
