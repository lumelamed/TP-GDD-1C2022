...
-- INSERT AUTO CON PROBLEMA

INSERT INTO COSMICOS.AUTO (AUTO_NUMERO ,AUTO_MODELO ,CODIGO_PILOTO ,CODIGO_ESCUDERIA ,MOTOR ,CAJA_NRO_SERIE)
select DISTINCT M.AUTO_NUMERO,M.AUTO_MODELO,P.CODIGO_PILOTO,E.CODIGO_ESCUDERIA,M.TELE_CAJA_NRO_SERIE,M.TELE_MOTOR_NRO_SERIE
...
Cannot insert the value NULL into column 'MOTOR', table 'GD1C2022.COSMICOS.AUTO'; column does not allow nulls. INSERT fails.
The statement has been terminated.

Si no hay telemetria no hay numero de serie de caja ni de motor. por eso algunos quedan como null en la caja y motor en el select. 
 */
